...
import com.example.yaacoov.utracker.barchart.formatters.ActionBarChartValueFormatter;
import com.example.yaacoov.utracker.barchart.formatters.ActionBaseIAxisValueFormatter;
import com.example.yaacoov.utracker.barchart.view.XYMarkerView;
...
public final class ActionBarChartConfigurator {

    private static final int MAX_VISIBLE_VALUE_COUNT = 60;

    private BarChart mBarChart;
    private ActionBaseIAxisValueFormatter mXAxisFormatter;

    private ActionBarChartDataSource mDataSource;
    private ActionBarChartViewModel mViewModel;

    public ActionBarChartConfigurator(BarChart barChart) {
        this.mBarChart = barChart;
    }

    public void setup(@NonNull final ActionBarChartDataSource dataSource,
                      @NonNull final ActionBarChartViewModel viewModel) {
    ...
    private void setData() {
        ...
        if (mBarChart.getData() != null &&
            ...
            barDataSet.setValueFormatter(new ActionBarChartValueFormatter());
