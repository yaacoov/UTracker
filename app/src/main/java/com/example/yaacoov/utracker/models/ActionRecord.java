...
public final class ActionRecord implements Parcelable {
    ...
    public ActionRecord(String userId, long createdAt, String name, int color, int target,
    ...
    public ActionRecord copy() {
        return new ActionRecord(userId, createdAt, name, color, target, resetFreq, resetTimestamp,
