...
public final class ActionDateUtils {
    ...
    public static boolean isDateInType(long date, ResetFrequency.Type type) {
        switch (type) {
            ...
            case WEEK:
                return ActionDateUtils.isDateInCurrentWeek(date);
            case MONTH:
                return ActionDateUtils.isDateInCurrentMonth(date);
            case YEAR:
                return ActionDateUtils.isDateInCurrentYear(date);
            case NEVER:
                return true;
            default:
